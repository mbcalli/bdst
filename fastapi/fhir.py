...
class Medication:
    ...
    def __init__(self, resourceType = "MedicationRequest", identifier = {}, basedOnpriorPrescription = None, groupIdentifier = {}, status = None, statusReason = {}, statusChanged = None, intent = None, category = {}, priority = None, doNotPerform = None, medication = {}, subject = None, informationSource = None, encounter = None, supportingInformation = None, authoredOn = None, requester = None, reported = None, performerType = {}, performer = None, device = {}, recorder = None, reason = {}, courseOfTherapyType = {}, insurance = None, note = None, renderedDosageInstruction = None, effectiveDosePeriod = None, dosageInstruction = None, dispenseRequest = {}, substitution = {}, eventHistory = None):
        self.resourceType = resourceType
        self.identifier = Identifier(**identifier)
        self.basedOnpriorPrescription = basedOnpriorPrescription
        ...
        self.medication = CodeableConcept(**medication)
        self.subject = subject
        ...
        self.performer = performer
        self.device = CodeableConcept(**device)
        self.recorder = recorder
        ...
        self.dispenseRequest = CodeableConcept(**dispenseRequest)
